...
describe('Training Cards', () => {
  ...
  // TODO: To refactor when Jenni merges her PR for https://github.com/medic/cht-core/issues/9488 as logic has changed
  it.skip('should display training after reload and complete training', async () => {
    await commonPage.goToMessages();
    await commonElements.waitForPageLoaded();
    // Unfinished trainings should appear again after reload.
    await browser.refresh();
