...
#git clone --single-branch --branch v3_scalability https://github.com/medic/cht-core.git;
#
#cd cht-core/tests/scalability/brac_v3
...
npm install
echo "jmeter install"
wget https://dlcdn.apache.org//jmeter/binaries/apache-jmeter-5.5.tgz -O ./apache-jmeter.tgz
mkdir ./jmeter
