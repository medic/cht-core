describe('number filters', () => {
  ...
  describe('maxInteger filter', () => {
    it('should render nothing when no number', function() {
      scope.number = undefined;
      element = compile('<div ng-bind-html="number | maxInteger"></div>')(scope);
      scope.$digest();
    ...
    it('should respect max when positive number', () => {
      scope.number = '123456';
      element = compile('<div ng-bind-html="number | maxInteger:something"></div>')(scope);
      scope.$digest();
      chai.expect(element.html()).to.equal('123456');

      element = compile('<div ng-bind-html="number | maxInteger:0"></div>')(scope);
      scope.$digest();
      chai.expect(element.html()).to.equal('123456');

      element = compile('<div ng-bind-html="number | maxInteger:-1000"></div>')(scope);
      scope.$digest();
      chai.expect(element.html()).to.equal('123456');

      element = compile('<div ng-bind-html="number | maxInteger:99"></div>')(scope);
      scope.$digest();
    ...
    it('should display correct positive number', () => {
      scope.number = 5;
      element = compile('<div ng-bind-html="number | maxInteger:9"></div>')(scope);
      scope.$digest();
      ...
      scope.number = 286;
      element = compile('<div ng-bind-html="number | maxInteger:999"></div>')(scope);
      scope.$digest();
      chai.expect(element.html()).to.equal('286');

      scope.number = 1985;
      element = compile('<div ng-bind-html="number | maxInteger:9999"></div>')(scope);
      scope.$digest();
