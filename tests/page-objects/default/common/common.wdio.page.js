...
const MULTIPLE_ACTIONS_MENU = '[test-id="multiple-actions-menu"]';
const fastActionFAB = () => $(`${FAST_ACTION_TRIGGER}${MULTIPLE_ACTIONS_MENU} .fast-action-fab-button`);
const fastActionFlat = () => $(`${FAST_ACTION_TRIGGER} .fast-action-flat-button`);
const multipleActions = () => $(`${FAST_ACTION_TRIGGER}${MULTIPLE_ACTIONS_MENU}`);
