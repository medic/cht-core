        ...
        .then(() => {
          const opts = {
            ...
            body: {
              ...
              name: 'Philip',
              contact: { name: 'Philip' },
              place: { name: 'PhilipPlace', type: DOC_IDS.HEALTH_CENTER, parent: 'PARENT_PLACE' },
            },
          };
  ...
  describe('POST/GET api/v2/users', () => {
    ...
    it('should create and query users using filters', async () => {
      const facilityE = await utils.request({
        path: '/api/v1/places',
        method: 'POST',
        body: { type: DOC_IDS.HEALTH_CENTER, name: 'Facility E', parent: 'PARENT_PLACE' },
      });
      const facilityF = await utils.request({
        path: '/api/v1/places',
        method: 'POST',
        body: { type: DOC_IDS.HEALTH_CENTER, name: 'Facility F', parent: 'PARENT_PLACE' },
      });
