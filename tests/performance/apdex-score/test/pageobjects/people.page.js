...
const { keyevent } = require('appium-uiautomator2-driver/build/lib/commands/keyboard');
...
class PeoplePage extends Page {
    ...
    get radioHouseholdRelationship () {
        return $('//*[contains(@text,"Relation with household")]//android.widget.RadioButton[contains(@text,"Son or")]');
    }
    ...
    get radioReportPregnancy () {
        return $('//*[contains(@text,"report the pregnancy?")]//android.widget.RadioButton[@text="Last menstrual period (LMP)"]');
    }
    ...
    get inputPreviousPregnancy () {
        return $('//*[contains(@text, "previous successful pregnancy")]//parent::android.view.View/android.widget.EditText');
    }
