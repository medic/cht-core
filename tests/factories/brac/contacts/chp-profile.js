...
module.exports = new Factory()
    ...
    .attr('g_education', () => {
        const gEducation = {
            education_level: Faker.faker.random.arrayElement(['basic', 'below_primary', 'primary_7', 'o_level', 'a_level', 'tertiary', 'diploma', 'degree']),
    ...
    .attr('g_other_details', () => {
        const gOtherDetails = {
            incentives: Faker.faker.helpers.uniqueArray(['bicycle', 'financial', 'mentorship', 'motorbike', 'phone', 'training', 'uniform', 'other'], Faker.faker.datatype.number({ min: 1, max: 8 })),
            other_incentives: Faker.faker.lorem.word(),
            chp_services: Faker.faker.helpers.uniqueArray(['disaster_risk', 'family_reproductive_health', 'first_aid', 'health_commodities', 'health_promotion', 'hygiene', 'pmtct', 'prevention_communicable', 'prevention_non_communicable', 'vital_stat'], Faker.faker.datatype.number({ min: 1, max: 10 }))
        };
