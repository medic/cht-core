...
- Specify which forms can be downloaded using Collect. Issue: https://github.com/medic/medic-webapp/issues/3607
- Validate sentinel transition configs at transition load time. Issue: https://github.com/medic/medic-webapp/issues/3585
- Add session expiry date in About screen. Issue: https://github.com/medic/medic-webapp/issues/3529
- Allow users to enter Bikram Sambat dates in Enketo forms on Android phones. Issue: https://github.com/medic/medic-webapp/issues/3513
- Information from the contact-summary is now available as input to forms. Issue: https://github.com/medic/medic-webapp/issues/3413
- Allow users to enter Bikram Sambat dates in Enketo forms in the web app. Issue: https://github.com/medic/medic-webapp/issues/3404
- Registration of a person from a report/action form is now possible. Issue: https://github.com/medic/medic-webapp/issues/2912
- Remove one level of facility hierarchy for local install users. Issue: https://github.com/medic/medic-webapp/issues/857

### Bug fixes

- Primary contact is showing the UUID. Issue: https://github.com/medic/medic-webapp/issues/3723
- Couch responds with 200 when a bad app_settings file is uploaded. Issue: https://github.com/medic/medic-webapp/issues/3674
- Select All in bulk delete doesn't work. Issue: https://github.com/medic/medic-webapp/issues/3646
- Only serve collect-specific XML forms to collect. Issue: https://github.com/medic/medic-webapp/issues/3642
- Exporting when filtered by report type exports more reports than are displayed in the web app. Issue: https://github.com/medic/medic-webapp/issues/3615
- Bulk delete fails when deleting more than a few hundred records. Issue: https://github.com/medic/medic-webapp/issues/3605
- Contact summary isn't rendering lineage. Issue: https://github.com/medic/medic-webapp/issues/3598
- Exporting reports filtered by place results in an empty xml. Issue: https://github.com/medic/medic-webapp/issues/3593
- Cannot log out of app. Issue: https://github.com/medic/medic-webapp/issues/3592
- Requesting forms should respond with 4xx on client error. Issue: https://github.com/medic/medic-webapp/issues/3569
- Can't view contacts for restricted user. Issue: https://github.com/medic/medic-webapp/issues/3517
- Bad error message when associated contact is not available in the local DB. Issue: https://github.com/medic/medic-webapp/issues/3499
- Gardener bug on startup when module_name is undefined. Issue: https://github.com/medic/medic-webapp/issues/3481
- Reports list showing when user doesn't have proper permission. Issue: https://github.com/medic/medic-webapp/issues/3452
- select2 in a repeat group does not work as expected in an Xform. Issue: https://github.com/medic/medic-webapp/issues/3430
- {{patient_name}} not found when patient was created by xform. Issue: https://github.com/medic/medic-webapp/issues/3419
- Search doesn't work in Nepali or with accented characters. Issue: https://github.com/medic/medic-webapp/issues/3392
- Remove nested contacts. Issue: https://github.com/medic/medic-webapp/issues/2635

### UI/UX improvements

- Sync status cut off in mobile view. Issue: https://github.com/medic/medic-webapp/issues/3703
- Hide Collect XForms from filter list in History tab. Issue: https://github.com/medic/medic-webapp/issues/3625
- Split the form configuration page into JSON and XML tabs. Issue: https://github.com/medic/medic-webapp/issues/3559
- Wrap text in tasks list. Issue: https://github.com/medic/medic-webapp/issues/3525
- Task summary screen looks ugly on desktop. Issue: https://github.com/medic/medic-webapp/issues/3521
- Send Report dropdown menu items are misaligned. Issue: https://github.com/medic/medic-webapp/issues/3469
- Disable tasks tour for admins. Issue: https://github.com/medic/medic-webapp/issues/3144
- Confirmation popup should not show on 'Error loading form'. Issue: https://github.com/medic/medic-webapp/issues/3045
- _May lose data_ warning displayed when form has no fields. Issue: https://github.com/medic/medic-webapp/issues/1601

### Performance improvements

- Remove modules.js attachment. Issue: https://github.com/medic/medic-webapp/issues/3684
- Use alternative pagination method for running batched migrations. Issue: https://github.com/medic/medic-webapp/issues/3553
...
- Don't eval() user input. Issue: https://github.com/medic/medic-webapp/issues/3546
- Set `Secure` setting on AuthSession cookie for HTTPS pages. Issue: https://github.com/medic/medic-webapp/issues/3182
