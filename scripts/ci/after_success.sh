...
if [ "$TRAVIS_BRANCH" == "develop" ]; then
    ...
    push 'http://service:a5nghmongP!@staging.dev.medicmobile.org/markets/alpha/upload'
fi;
...
if [ "$TRAVIS_BRANCH" == "testing" ]; then
    ...
    mv tmp.json kanso.json &&
    push 'http://service:a5nghmongP!@staging.dev.medicmobile.org/markets/beta/upload'
fi;
