  ...
  checkOHWDuplicates: checkOHWDuplicates,
    ...
    */
    ...
    extractDetails: function(doc) {
        return {
            clinic_name: module.exports.getClinicName(doc),
            clinic_phone: module.exports.getClinicPhone(doc),
            patient_id: doc.patient_id,
            serial_number: doc.serial_number
        }
    },
    addReply: function(doc, message) {
        module.exports.addMessage(doc, {
            phone: clinic_phone,
            message: mustache.to_html(message, module.exports.extractDetails(doc))
        });
    },
    addTranslatedMessage: function(doc, error) {
        module.exports.addError(doc, {
