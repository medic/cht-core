...
exports.facilities_by_phone = {
    map: function (doc) {
        if (doc.type === 'clinic' ||
            ...
            emit([doc.contact.phone, doc.type, doc.contact.name], doc);
        }
    }
};
 ...
 * HACK only compatible with MSBR/MSBC form using ref_rc
 */
exports.facilities_by_referral = {
    map: function (doc) {
        if (doc.type === 'tasks_referral' && doc.form && doc.form.ref_rc) {
