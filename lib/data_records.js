...
var isBulkUpdateDone = function(changesData, data) {
    console.log('isBulkUpdateDone',changesData,data);
    var valid = true;
...
var setupModalClose = function(data) {
    console.log('setupModalClose data', data);
    ...
    function onRecordUpdate(ev, changesData) {
        console.log('onRecordUpdate changesData', changesData);
...
var handleClickRevision = function(ev) {
    ...
    console.log('handling click, btn rev', rev);
    // disable btn until done processing
    $btn.addClass('disabled');

    function updateRevNav(doc) {

        console.log('updateRevNav', doc);
    ...
    function renderPrevRevision(doc) {
        console.log('renderPrevRevision doc', doc);
        _.each(revs_info, function(rev, idx) {
            var prev = revs_info[idx+1];
            if (doc._rev === rev.rev) {
                if (prev) {
                    console.log('renderPrevRev calling fetchDoc', doc._id, prev.rev);
