...
exports.addListeners = function() {
    ...
    var handleEditInvalid = function(ev) {
        ev.preventDefault();
        ...
        var $m = $(templates.render('edit_invalid.html', {}, {}));
        $m.modal('show');
    ...
    $(document).on(
        'click', '.controls .edit-mode .edit-invalid', handleEditInvalid
    );
...
exports.removeListeners = function() {
    ...
    $(document).off('click', '.controls .edit-mode .edit-invalid');
