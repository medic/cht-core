...
var onDataRecordUpdated = function(ev, result) {
    ...
    // undo makeDataRecordReadable
    sms_utils.makeDataRecordOriginal(result.doc);

    // attach original doc to element with jquery data api. use separate jquery
    // call, for some reason chaining failed.
    div.data('data-record', result.doc);
