...
exports.handleSendMessage = function(ev) {
    ...
    function validate() {
        var phone = updateValidationResult(validatePhoneNumbers, $phone);
        var message = updateValidationResult(validateMessage, $form.find('[name=message]'));
