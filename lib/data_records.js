...
var subChanges = function() {
    console.log('calling subChanges');
    var opts = {include_docs: true, filter:'kujua-base/data_records'};
    db.changes(opts, function() {
        // unsub to avoid setting up multiple listeners
        console.log("unsub'ing changes feed");
        return false;
    });
    db.changes(opts, function(err,data) {
        ...
        _.each(data.results, function(result) {
            ...
            console.log('processing result in changes handler');
