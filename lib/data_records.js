...
var renderRecords = function() {
    ...
    if(!viewName) {
        ...
        utils.getView(null, viewName, q, render);
    }
};
...
var loadPhones = function() {
    ...
    utils.getView(null, 'phones_by_district_and_health_center', q,
        function(err, data) {
            if (err) {
                return alert(err);
            }
    ...
    utils.getView(null, 'phones_by_district_and_clinic', q,
        function(err, data) {
            if (err) {
                return alert(err);
            }
    ...
    utils.getView(null, 'phones_by_district', q, function(err, data) {
        if (err) {
            return alert(err);
        }
        for (var i in data.rows) {
