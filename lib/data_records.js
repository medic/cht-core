...
exports.validateSms = function(recipients, $phoneField, $messageField) {
    ...
    function validateMessage() {
        return {
            valid: !!$messageField.val().trim(),
            message: 'Please include a message.'
        }
    };

    function updateValidationResult(fn, elem) {
    ...
    var phone = updateValidationResult(validatePhoneNumbers, $phoneField);
    var message = updateValidationResult(validateMessage, $messageField);
    ...
    return _.uniq(
        _.flatten(_.map(recipients, function(r) {
            if (r.everyoneAtFacility) {
                return _.map(r.docs, function(d) {
                    return {
...
exports.handleSendMessage = function(ev) {
    ...
    function onSubmit(ev) {
        ...
        if (!exports.validateSms(recipients, $phone, $message)) {
            return;
        }
