    ...
    events.once('afterResponse', function() {
        ...
        var _switchLocale = function () {
            ...
            selector
                ...
                .find('.translated')
                .each(function() {
                    var message = _findMessage(
                        $(this).data('messages'), language
                    );
        ...
        var _hasDirtyTranslations = function() {
            var dirty = false;
            selector.closest('form').find('.translated').each(function() {
