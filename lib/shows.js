...
var removeConfirm = function(doc, callback) {
    ...
    $('#delete-confirmation .btn-primary').click(function(ev) {
        ev.preventDefault();
...
exports.users = function (_doc, _req) {
    ...
    events.once('afterResponse', function() {
        ...
        $('body').click(function (_ev) {
          ...
          $('#user-list tbody').find('input[type=radio]')
        ...
        $('#user-list tbody').on('click', function (_ev) {
            ...
            if ($(_ev.target).is('.delete')) {
                var confirm_text =
                    "Are you sure you want to delete the user '"
                        + user.name + "'? This operation cannot be undone.";
                ...
                $('#user-list tr.selected').removeClass('selected');
                tr.addClass('selected');
                
                if ($('#user-form #_id').val() != user._id) {
