...
exports.sms_forms = function (doc, req) {
    ...
    events.on('afterResponse', function() {
        ...
        db.getView('kujua-export', 'data_records_valid', function(err, data) {
            if (err) {
                return alert(err);
            }
            ...
            /*
            // bind to form download buttons, should move this into lib/events
            // but .live('submit',...) doesn't seem to work for this event.
