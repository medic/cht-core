...
exports.configuration = function (_doc, _req) {
    ...
    events.once('afterResponse', function() {
        ...
        $('#configuration-form').on('click', '.submit', function (_ev) {
            ...
            var url = baseURL.replace('/_rewrite', '/_update') + 
                '/update_config/' + 
                '_design%2Fkujua-lite'; // TODO get this bit from somewhere
            $.ajax({
                method: 'PUT',
                ...
                success: function (_data, _text, _xhr) {
                    ...
                    console.log('success! ', _data, _text, _xhr);
                },
                error: function (_xhr, _status, _err) {
                    // TODO show error message
                    console.log('error! ', _err, _status, _xhr);
                }
            });
