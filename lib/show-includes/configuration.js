...
exports.configuration = function (_doc, _req) {
    ...
    events.once('afterResponse', function() {
            ...
            function _render(_err, _forms) {
                ...
                $('#forms-installed').html(
                    templates.render('configuration/forms_installed.html', {}, {
                        forms: _.map(Object.keys(_forms), function(key) {
                            return _forms[key];
                        }),
                        error: _err
                    })
        ...
        var _uploadForms = function(_ev) {
            ...
            $('#forms-upload-form .loading-wrapper i').removeClass('hide');
            ...
            function finish(_error) {
                ...
                $('#forms-upload-form .loading-wrapper i').addClass('hide');
                // reset uploader
        ...
        $('#forms-download').on('click', function() {
            var formArray = _.values(info.forms);
            var a = $(this)[0];
            var URL = window.webkitURL || window.URL;
            var file = new Blob(
                [JSON.stringify(formArray, null, 4)], 
...
exports.workflows = function (_doc, _req) {
    ...
    events.once('afterResponse', function() {
        ...
        utils.updateTopNav('schedules', 'Schedule');
    });
