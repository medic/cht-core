...
module.exports = _.union(rewrites, [
    ...
    {from: '/sms_messages_by_form', to: '_list/sms_messages/sms_messages_by_form'},
    {from: '/sms_messages_by_from', to: '_list/sms_messages/sms_messages_by_from'},
    {from: '/sms_messages_by_timestamp', to: '_list/sms_messages/sms_messages_by_timestamp'},
