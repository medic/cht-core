...
module.exports = _.union(rewrites, [
    ...
    {from: '/data_records', to: '_list/data_records/data_records', method: 'GET'},
    //{from: '/docs/:page', to: '_show/docs', method: 'GET'},
    //{from: '/docs/img/*', to: 'docs/install/img/*', method: 'GET'},
    //{from: '/docs/gateway/*', to: 'docs/install/gateway/*', method: 'GET'},
