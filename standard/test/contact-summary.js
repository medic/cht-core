...
if (contact.type === 'person') {
    ...
    if (report.form === 'pregnancy' || report.form === 'P') {
      ...
      if (subsequentDeliveries.length > 0) {
        ...
        pastPregnancies.fields.push(
          { label: 'contact.profile.delivery_code.' + deliveryCode.toLowerCase(), value: birthdate, filter: 'relativeDay', width: 6 },
  ...
  fields = [
    { label: 'ID', value: contact.place_id, width: 3 },
    { label: 'Notes', value: contact.notes, width: 9 }
  ];
}
