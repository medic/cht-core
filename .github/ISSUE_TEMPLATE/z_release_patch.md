...
- [ ] Upgrade the [demo instance](https://demo-cht.dev.medicmobile.org/) by running the [upgrade script](https://github.com/medic/cht-core/tree/master/scripts/build/update.cht-demo.sh) (eg `./update.cht-demo.sh`)
