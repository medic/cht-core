...
- [#5395](https://github.com/medic/medic/issues/5395): `fix-user-db-security` migration needs to be optimised for larger databases
...
- [#5420](https://github.com/medic/medic/issues/5420): Fix Sentinel read doc deletes for large databases
