...
- Add support for firing REST requests when documents are created / changed. [medic#5499](https://github.com/medic/medic/issues/5499)
- SIH integration. [medic#4813](https://github.com/medic/medic/issues/4813)

## Performance

- [medic#4128](https://github.com/medic/medic/issues/4128): Improve Sentinel performance
With 200 docs:
  before: 66.6s
  after: 33.4s

- [medic#4423](https://github.com/medic/medic/issues/4423): Loading the reports tab is blocking and CPU-heavy on large partners
With 5000 facilities:

loading the reports tab:
  before: 7247ms
  after: 1843ms
...
- [medic#4857](https://github.com/medic/medic/issues/4857): Allow sentinel transitions to run synchronously against incoming SMS messages
TODO

- [medic#5455](https://github.com/medic/medic/issues/5455): Performance regression when loading reports
  before: 1002ms
  after: 732ms

- [medic#5260](https://github.com/medic/medic/issues/5260): Offline users are caching unused font files
Saving: 2.4mb

- [medic#5489](https://github.com/medic/medic/issues/5489): Minify all JavaScript files
Saving: 8kb

- [medic#5490](https://github.com/medic/medic/issues/5490): Compress TTF font files
Saving: 189kb
...
- [medic#5596](https://github.com/medic/medic/issues/5596): Sort muted contacts to the bottom of the contacts list
