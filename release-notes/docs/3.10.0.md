...
- [Improved geolocation data](#improved-geolocation-data)
...
This release adds a new `replication_depth` configuration option that limits the depth of replicated reports. This allows app builders to configure roles that can replicate deeper contacts and report against these contacts. This configuration option does not allow for downloading reports about these contacts that have been created by other users.  
