...
- [cht-core#6562](https://github.com/medic/cht-core/issues/6562): Switching between tabs while tasks are calculated can result in having multiple task documents with the same emission id
