...
For full Webapp support for contacts of hardcoded types, that also have a `contact_type` property, ensure your configuration is deployed using [medic-conf 3.4.1](https://github.com/medic/medic-conf/blob/master/release-notes.md#340) or greater.
