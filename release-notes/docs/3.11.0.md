...
- This upgrade can be rolled out remotely. Users will download the new version in the background and be prompted to reload the app when it's ready. A small amount (TODO: quantify) of data will be used to download the new version.
...
This feature wasn't documented or tested and hasn't been used in production for some time so it has been removed. To read more about this feature or if this breaking change affects your read this [forum post](https://forum.communityhealthtoolkit.org/t/feature-removal-proposal-reporting-rates/1053).
...
The UI framework has been upgraded from the deprecated AngularJS v1.6 to Angular v10.0 which will make development of the Core Framework easier and more reliable. It also makes it easier to keep on the latest version of Angular which means we can keep up to date and on a supported version from now on.
