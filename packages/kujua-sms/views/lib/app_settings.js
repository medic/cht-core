...
module.exports = {
   ...
   "translations": [
      ...
      },
      {
          ...
          "default": "{{number}} places",
          "translations": [
              {
                  "locale": "en",
                  "content": "{{number}} places"
              }
          ]
      },
      {
      ...
      {
          "key": "All contact types",
          "default": "All contact types",
          "translations": [
              {
                  "locale": "en",
                  "content": "All contact types"
              }
          ]
      },
      {
          "key": "Number of contact types",
          "default": "{{number}} contact types",
          "translations": [
              {
                  "locale": "en",
                  "content": "{{number}} contact types"
              }
          ]
      },
      {
      ...
      },
      {
          ...
          "default": "You can start a tour at any time by clicking the menu icon in the top right corner of the page. Which tour would you like to run?",
          "translations": [
              {
                  "locale": "en",
                  "content": "You can start a tour at any time by clicking the menu icon in the top right corner of the page. Which tour would you like to run?"
              }
          ]
      },
      {
      ...
      },
      {
          ...
          "default": "Select one or more places to filter the list of reports to only those from the chosen places.",
          "translations": [
              {
                  "locale": "en",
                  "content": "Select one or more places to filter the list of reports to only those from the chosen places."
              }
          ]
      },
      {
      ...
      },
      {
          ...
          "default": "Please select a contact",
          "translations": [
              {
                  "locale": "en",
      ...
      },
      {
          ...
          "default": "Restricted to their place",
          "translations": [
              {
                  "locale": "en",
                  "content": "Restricted to their place"
              }
          ]
      },
      {
      ...
      {
          "key": "Error fetching contacts",
          "default": "Error fetching contacts",
          "translations": [
              {
                  "locale": "en",
                  "content": "Error fetching contacts"
              }
          ]
      },
      {
          "key": "No contacts found",
      ...
      {
          "key": "No more contacts",
          "default": "No more contacts",
          "translations": [
              {
                  "locale": "en",
                  "content": "No more contacts"
              }
          ]
      },
      {
      ...
      {
          "key": "Contacts file help",
          "default": "Select the .json file with the contacts.",
          "translations": [
              {
                  "locale": "en",
                  "content": "Select the .json file with the contacts."
              }
          ]
      },
      {
          "key": "Error parsing file",
          "default": "Error parsing file",
          "translations": [
              {
                  "locale": "en",
