...
exports.get_recip_phone_no_recipients = function(test) {
    ...
    // empty parents
    var clinic = {
        "type":"clinic","name":"Example clinic 1",
        "contact":{"name":"Sam Jones","phone":"+13125551212"},
            "parent":{"contact":{},
                "parent":{"contact":{},
                    "parent":{"contact":{}}}}};
    ...
    // Clinic -> Health Center
    var ph1 = lists.getRecipientPhone('MSBR','+13125551212',clinic);
    test.same(ph1, undefined);

    // Health Center -> Clinic
    var ph2 = lists.getRecipientPhone('MSBC','+17084449999',clinic);
    test.same(ph2, undefined);

    // Hospital -> Health Center
    var ph3 = lists.getRecipientPhone('MSBC','+14151112222',clinic);
    test.same(ph3, undefined);

    // Health Center -> Hospital
    var ph4 = lists.getRecipientPhone('MSBB','+17084449999',clinic);
    test.same(ph4, undefined);
