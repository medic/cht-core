...
exports.paginate = function (test) {
    ...
    rows = pagination.prepare(req, [records[0], records[1], records[2], records[3]], {perPage: 3});
    ...
    rows = pagination.prepare(req, [records[3], records[4], records[5], records[6]], {perPage: 3});
    pagination.paginate(head, req, '/sms_messages', rows);
    ...
    rows = pagination.prepare(req, [records[6], records[7], records[8]], {perPage: 3});
    pagination.paginate(head, req, '/sms_messages', rows);
    ...
    rows = pagination.prepare(req, [records[6], records[5], records[4], records[3]], {perPage: 3});
    pagination.paginate(head, req, '/sms_messages', rows);
    ...
    rows = pagination.prepare(req, [records[3], records[2], records[1], records[0]], {perPage: 3});
    pagination.paginate(head, req, '/sms_messages', rows);
    ...
    rows = pagination.prepare(req, [records[0], records[1], records[2], records[3], records[4]], {perPage: 3});
    pagination.paginate(head, req, '/sms_messages', rows);
    ...
    rows = pagination.prepare(req, [records[3], records[4], records[5], records[6]], {perPage: 3, filter: 'a'});
    pagination.paginate(head, req, '/sms_messages', rows);
    
    test.same(nextLink.hidden, false);
    test.same(nextLink.url, baseURL + '/sms_messages?limit=4&startkey=%5B%22a%22%2C-1331724438195%2C%224%22%5D');
    
    
    head = {total_rows: records.length, offset: 6};
    req = {query: {}};
    
    rows = pagination.prepare(req, [records[6], records[7], records[8], records[9]], {perPage: 3, filter: 'a'});
    pagination.paginate(head, req, '/sms_messages', rows);
