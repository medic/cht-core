...
const NOUVEAU_INDEX_INFO_BY_DDOC = {
  'medic': {
    ...
    'docs_by_replication_key': {
      name: '_design/auth/docs_by_replication_key',
      search_index: { 
        update_seq: 1263237,
        purge_seq: 0,
        num_docs: 1261007,
  ...
  it('v1 returns successfully', () => {
    ...
    return service.jsonV1().then(actual => {
      ...
      chai.expect(actual.couchdb).to.deep.equal({
        medic: {
          ...
          nouveau_indexes: [
            ...
            {
              file_size: 218427370,
              name: 'auth/docs_by_replication_key',
              doc_count: 1261007,
            },
          ],
        },
      ...
      chai.expect(request.get.args).to.deep.equalInAnyOrder([
        ...
        [{ json: true, url: `${environment.serverUrl}/${environment.db}/_design/auth/_info` }],
        [{ json: true, url: `${environment.serverUrl}/${environment.db}/_design/api/_info` }],
        [{ json: true, url: `${environment.serverUrl}/${environment.db}/_design/client-contacts/_info` }],
        [{ json: true, url: `${environment.serverUrl}/${environment.db}/_design/client-reports/_info` }],
