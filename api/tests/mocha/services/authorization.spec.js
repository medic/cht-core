...
describe('Authorization service', () => {
  ...
  describe('getAuthorizationContext', () => {
    ...
    it('queries correct views with correct keys when depth is not infinite', () => {
      ...
      return service
        ...
        .then(() => {
          ...
          db.medic.query.args[0][0].should.equal('auth/contacts_by_depth');
    ...
    it('returns contactsByDepthKeys array, contact and report depths', () => {
      db.medic.query.withArgs('auth/contacts_by_depth').resolves({
        rows: [
    ...
    it('should add primary contacts when enabled', async () => {
      db.medic.query.withArgs('auth/contacts_by_depth').onCall(0).resolves({
        rows: [
          { id: 'aaa', key: ['aaa', 0], value: { shortcode: 'aaa', primary_contact: 'contact' } },
          { id: '1', key: ['aaa', 1], value: { shortcode: 's1', primary_contact: 'contact2' } },
        ]
      });
      db.medic.query.withArgs('auth/contacts_by_depth').onCall(1).resolves({
        rows: [
      ...
      db.medic.query.args[0].should.deep.equal(['auth/contacts_by_depth', { keys: [[ 'aaa', 0], [ 'aaa', 1]] }]);
      db.medic.query.args[1].should.deep.equal(['auth/contacts_by_depth', { keys: [['contact2'], ['contact']] }]);
    });
    ...
    it('should only query for unknown primary contacts', async () => {
      ...
      db.medic.query.args[0].should.deep.equal([
        'auth/contacts_by_depth',
        { keys: [[ 'aaa', 0], [ 'aaa', 1], [ 'aaa', 2]] }
      ]);
      db.medic.query.args[1].should.deep.equal(['auth/contacts_by_depth', { keys: [['contact']] }]);
    });
    ...
    it('should set lowest place depth for primary contacts', async () => {
      ...
      db.medic.query.args[1].should.deep.equal(['auth/contacts_by_depth', { keys: [['contact2'], ['contact3']] }]);
    }); 
  ...
  describe('getScopedAuthorizationContext', () => {
    ...
    it('should assign correct subjectIds when replicating hierarchy primary contacts', async () => {
      ...
      db.medic.query.withArgs( 'auth/contacts_by_primary_contact').resolves({
        rows: [
          {
            id: 'place_id',
            key: 'contact_id',
      ...
      db.medic.query.withArgs( 'auth/contacts_by_primary_contact').args.should.deep.equal([[
        'auth/contacts_by_primary_contact',
        {
          include_docs: true,
