...
describe('self_report transition', () => {
  ...
  describe('onMatch', () => {
    ...
    it('should hydrate patient and attach it to the doc', () => {
      ...
      getContactUuids.resolves({ data: ['the_contact'], cursor: null });
    ...
    it('should throw db errors', () => {
      const doc = { from: 'aaa' };
      getContactUuids.rejects({ some: 'err' });
      return transition
        .onMatch({ doc })
    ...
    it('should preserve other fields', () => {
      ...
      getContactUuids.resolves({ data: ['contact_uuid'], cursor: null });
      getContactWithLineage.resolves(patient);
    ...
    it('should pick the first result when multiple found', () => {
      ...
      getContactUuids.resolves({ data: ['contact1', 'contact2'], cursor: null });
      getContactWithLineage.resolves(patient);
    ...
    it('should add task if a message is configured and sender not found - sms locale', () => {
      config.get.returns([ {
        form: 'the_form',
        messages: [
          {
