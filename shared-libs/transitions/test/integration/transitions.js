...
describe('functional transitions', () => {
  ...
  describe('processDocs', () => {
    ...
    it('should run all async transitions over docs and save all docs', () => {
      ...
      // update_clinics
        .withArgs(VIEWS.CONTACTS_BY_PHONE, { key: 'phone1', include_docs: false, limit: 1 })
        .resolves({ rows: [{ id: 'contact1', key: 'phone1' }] })
        .withArgs(VIEWS.CONTACTS_BY_PHONE, { key: 'phone2', include_docs: false, limit: 1 })
        .resolves({ rows: [{ key: 'phone2' }] })
        .withArgs(VIEWS.CONTACTS_BY_PHONE, { key: 'phone3', include_docs: false, limit: 1 })
        .resolves({ rows: [{ id: 'contact3', key: 'phone3' }] })
        //update_sent_by
        .withArgs(VIEWS.CONTACTS_BY_PHONE, { key: 'phone1', include_docs: true })
        .resolves({ rows: [{ id: 'contact1', doc: contact1 }] })
        .withArgs(VIEWS.CONTACTS_BY_PHONE, { key: 'phone2', include_docs: true })
        .resolves({ rows: [{ key: 'phone2' }] })
        .withArgs(VIEWS.CONTACTS_BY_PHONE, { key: 'phone3', include_docs: true })
