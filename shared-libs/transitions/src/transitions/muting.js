...
const isRelevantReport = (doc, info = {}) => {
  console.log(doc && isMuteForm(doc.form), 'isMuteForm');
  console.log(doc && isUnmuteForm(doc.form), 'isUnmuteForm');
  console.log(doc && utils.isValidSubmission(doc), 'isValidSubmission');
