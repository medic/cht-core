...
if(typeof define === 'function') {
  define('openrosa-xpath-extensions',[],function() { return openrosa_xpath_extensions; });
...
if(typeof define === 'function') {
  define('extended-xpath',[],function() { return ExtendedXpathEvaluator; });
} else if(typeof module === 'object' && typeof module.exports === 'object') {
...
define( 'enketo-js/FormModel',[ 'merge-xml', 'enketo-js/utils', 'jquery', 'openrosa-xpath-extensions', 'extended-xpath', 'enketo-js/plugins', 'enketo-js/extend', 'jquery.xpath' ],
        function( MergeXML, utils, $, openrosa_xpath_extensions, ExtendedXpathEvaluator ) {
    'use strict';
    ...
    FormModel.prototype.evaluate = function( expr, resTypeStr, selector, index, tryNative ) {
        ...
        if ( !result ) {
            try {
                ...
                // TODO we could probably just rewrite this behaviour instead of worrying about rebinding the XPath evaluator
...
define( 'enketo-js/widgets',[ 'text!enketo-config', 'enketo-js/support', 'q', 'jquery' ], function( configStr, support, Q, $ ) {
    'use strict';
...
define( 'enketo-widget/date/datepicker-extended',[ 'enketo-js/Widget', 'enketo-js/support', 'jquery', 'enketo-widget/date/bootstrap3-datepicker/js/bootstrap-datepicker' ],
...
define( 'enketo-widget/time/timepicker-extended',[ 'enketo-js/Widget', 'enketo-js/support', 'jquery', 'enketo-widget/time/bootstrap3-timepicker/js/bootstrap-timepicker' ],
    function( Widget, support, $ ) {
        'use strict';
...
define( 'enketo-widget/datetime/datetimepicker-extended',[ 'enketo-js/Widget', 'enketo-js/support', 'jquery', 'enketo-js/extend',
