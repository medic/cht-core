...
describe('ImportContacts service', function() {
  ...
  it('creates person docs when required', function(done) {
    ...
    const contact1 = { _id: 1, contact: { name: 'john', phone: '+123', 
      type: docTypes.CONTACT, contact_type: 'chp' } };
    ...
    service([contact1, contact2, contact3], true)
      .then(function() {
        ...
        chai.expect(put.args[0][0].contact.type).to.equal(docTypes.CONTACT);
        ...
        // save contact
        chai.expect(put.args[3][0].type).to.equal(docTypes.CONTACT);
