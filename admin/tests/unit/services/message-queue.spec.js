describe('MessageQueue service', function() {
  ...
  describe('query', () => {
    ...
    it('should format results', () => {
      ...
      allDocs.resolves({
        rows: [{ doc: { _id: 'contact1', type: 'person', name: 'James', phone: 'phone1' } }]
      });
      ...
      return service.query('due').then(result => {
        ...
        chai.expect(allDocs.args[0][0]).to.deep.equal({ keys: ['contact1'], include_docs: true });
    ...
    it('should query for unique recipients', () => {
      ...
      allDocs.resolves({
        rows: [
          { doc: { _id: 'contact1', type: 'person', name: 'contact one', phone: 'phone1' } },
          { doc: { _id: 'contact2', type: 'person', name: 'contact two', phone: 'phone2' } },
        ]
      });
    ...
    it('should query for unique patient ids, place ids and contacts', () => {
      ...
      allDocs.resolves({ rows: [{ doc: { _id: 'recipient_id', type: 'person', phone: 'recipient' }}]});
    ...
    it('filters correct registrations and calls messageUtils with correct parameters', () => {
      ...
      allDocs.resolves({ rows: [
        { doc: { _id: 'recipient1_id', type: 'person', phone: 'recipient1', name: 'recipient 1' }},
        { doc: { _id: 'recipient2_id', type: 'person', phone: 'recipient2', name: 'recipient 2' }},
        { doc: { _id: 'recipient3_id', type: 'person', phone: 'recipient3', name: 'recipient 3' }}
      ]});
