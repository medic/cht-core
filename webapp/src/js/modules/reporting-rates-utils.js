...
(function() {
  ...
  exports.getTotals = function(facilities, reports, dates) {
    ...
    t.not_submitted_percent = Math.round((t.not_submitted / t.expected_reports) * 100);
    ...
    var total_percent = t.incomplete_percent + t.not_submitted_percent + t.complete_percent;
    ...
    if (
      total_percent !== 100 &&
      t.incomplete_percent !== t.not_submitted_percent &&
      t.not_submitted_percent !== t.complete_percent &&
      t.incomplete_percent !== t.complete_percent
    ) {
