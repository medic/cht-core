...
angular.module('inboxServices').factory('ContactChangeFilter', function(ContactSchema) {
  'ngInject';
  'use strict';
  ...
  var matchReportSubject = function(report, contact) {
    ...
    if (
      (report.doc.patient_id && report.doc.patient_id === contact.doc.patient_id) ||
