...
angular.module('inboxServices').factory('SendMessage', function($q, DB, ExtractLineage, Settings, UserSettings) {
  'use strict';
  'ngInject';
  ...
  var resolvePhoneNumbers = function(recipients) {
    ...
    return recipients.map(function(recipient) {
      var phone = recipient.text || recipient.doc.contact.phone; // from select2 // from LHS message bar
