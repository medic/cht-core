...
angular.module('inboxServices').factory('DBSync', function($interval, $log, $q, Auth, DB, Session) {
  'use strict';
  'ngInject';
  ...
  return function(updateListener) {
    ...
    return $q.all([replicateFrom(updateListener), replicateTo(updateListener)]);
  };
});
