...
(function() {
  ...
  inboxServices.factory('AnalyticsModules', function($log, $q, ScheduledForms, Settings) {
    'ngInject';
    ...
    var getTargetsModule = function(settings) {
      return {
        ...
        available: function() {
          return settings.tasks && settings.tasks.targets && settings.tasks.targets.enabled;
        },
      };
    };
    ...
    return function() {
      return $q.all([Settings(), ScheduledForms()]).then(function(results) {
