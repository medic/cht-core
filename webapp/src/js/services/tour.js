...
angular
  ...
  .service('Tour', function($q, $state, $timeout, $translate, AnalyticsModules, Auth, Session) {
    'use strict';
    'ngInject';
    ...
    var getAnalyticsTour = function() {
      return $q
        .all([AnalyticsModules(), Auth('can_view_analytics')])
