...
angular
  ...
  .service('ContactSave', function($q, DB, EnketoTranslation, ExtractLineage) {
    'use strict';
    'ngInject';
    ...
    function prepareSubmittedDocsForSave(schema, original, submitted) {
      ...
      return prepareAndAttachSiblingDocs(schema, submitted.doc, original, submitted.siblings).then(
        function(siblings) {
    ...
    return function(schema, form, docId, type) {
      return $q
        ...
        .then(function(original) {
          var submitted = EnketoTranslation.contactRecordToJs(
