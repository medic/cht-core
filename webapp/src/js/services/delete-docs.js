...
(function() {
  ...
  inboxServices.factory('DeleteDocs', function($log, $q, Changes, DB, ExtractLineage, Session) {
    'ngInject';
    ...
    var deleteAndUpdateDocs = function(docsToDelete, eventListeners) {
      if (Session.isOnlineOnly()) {
        ...
        return utils.updateParentContacts(docsToDelete).then(function(updatedParents) {
