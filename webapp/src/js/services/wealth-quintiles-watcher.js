...
angular.module('inboxServices').factory('WealthQuintilesWatcher', function(Changes, DB) {
  'ngInject';
  'use strict';
    ...
    start: function() {
      Changes({
        ...
        filter: function(change) {
          return (
            change.doc.fields && Object.keys(change.doc.fields).indexOf('NationalQuintile') !== -1
          );
        },
