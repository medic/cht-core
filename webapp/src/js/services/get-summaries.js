...
angular.module('inboxServices').factory('GetSummaries', function(DB, Session) {
  'use strict';
  'ngInject';
  ...
  var summarise = function(doc) {
    ...
    var isMissingSubjectError = function(error) {
      ...
      if (
        error.fields.indexOf('patient_id') !== -1 ||
    ...
    var getSubject = function(doc) {
      var subject = {};
      var reference = doc.patient_id || (doc.fields && doc.fields.patient_id) || doc.place_id;
