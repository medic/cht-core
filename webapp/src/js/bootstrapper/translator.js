...
var TRANSLATIONS = {
  ...
  ne: {
    FETCH_INFO: ({ count, total }) => eurodigit.to_non_euro.devanagari(`डकुमेन्ट लोड हुँदै  (${count} मध्ये ${total} डकुमेन्ट)…`),
    LOAD_APP: 'एप लोड गर्दै…',
    PURGE_INIT: 'डाटा जाँच गर्दै…',
    PURGE_INFO: ({ count, percent }) => eurodigit.to_non_euro.devanagari(`${count} वटा डकुमेन्ट सफा गरीयो (${percent}% कार्य सम्पन्न)…`),
