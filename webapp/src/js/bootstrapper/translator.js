...
const TRANSLATIONS = {
  en: {
    FETCH_FORMS: ({ count, total }) => `Fetching forms (${count} of ${total})…`,
  ...
  es: {
    FETCH_FORMS: ({ count, total }) => `Obteniendo formularios (${count} de ${total})…`,
  ...
  sw: {
    FETCH_FORMS: ({ count, total }) => `Inachukua fomu (${count} kati ya ${total})…`,
  ...
  ne: {
    FETCH_FORMS: ({ count, total }) => eurodigit.to_non_euro.devanagari(`${total} मध्ये ${count} फारम लोड हुँदै…`),
  ...
  fr: {
    FETCH_FORMS: ({ count, total }) => `Récupération des formulaires (${count} sur ${total})…`,
  ...
  hi: {
    FETCH_FORMS: ({ count, total }) => `फ़ॉर्म लोड हो रहे हैं (${total} में से ${count})…`,
  ...
  id: {
    FETCH_FORMS: ({ count, total }) => `Mengambil formulir (${count} dari ${total})…`,
  ...
  ar: {
    FETCH_FORMS: ({ count, total }) => `جارٍ جلب النماذج (${count} من ${total})…`,
  ...
  pt: {
    FETCH_FORMS: ({ count, total }) => `Obtendo formulários (${count} de ${total})…`,
