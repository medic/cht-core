angular.module('inboxControllers').controller('ReportsAddCtrl',
  function (
        ...
        return $q.all([
          ...
          Enketo.render('#report-form', results[1].id, results[0], markFormEdited)
            ...
            .then(() => {
              ...
              Telemetry.record(
                `reports:enketo:${telemetryData.form}:${telemetryData.action}:render`,
    ...
    $scope.save = function() {
      ...
      Telemetry.record(
        `reports:enketo:${telemetryData.form}:${telemetryData.action}:user_edit_time`,
      ...
      Enketo.save(formInternalId, $scope.form, geolocation, reportId)
        ...
        .then(() => {
          ...
          Telemetry.record(
            `reports:enketo:${telemetryData.form}:${telemetryData.action}:save`,
