...
describe('contacts_by_type_freetext', () => {
  [
    ['online view', loadView('medic-db', 'medic-client', 'contacts_by_type_freetext')],
    ['offline view', buildViewMapFn(medicOfflineFreetext.views.contacts_by_type_freetext.map)],
  ].forEach(([name, mapFn]) => {
    describe(name, () => {
