describe('HydrateMessages service', () => {
  ...
  it('returns valid outgoing message', () => {
    const doc = {
      _id: 12345,
      kujua_message: true,
    ...
    lineageModelGenerator.reportSubject.returns(Promise.resolve({
      _id: 'lid', doc: contact, lineage: lineage
    }));
  ...
  it('returns valid incoming message', () => {
    const doc = {
      _id: 12345,
