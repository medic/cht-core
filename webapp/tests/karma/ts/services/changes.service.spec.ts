  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      providers: [
        ...
        { provide: SessionService, useValue: { isOnlineOnly: sinon.stub(), userCtx: sinon.stub().returns({ name: 'user' }) } },
        { provide: DbService, useValue: { get: dbMock } },
      ]
    });
