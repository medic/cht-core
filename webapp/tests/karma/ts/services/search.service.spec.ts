...
describe('Search service', () => {
  ...
  describe('dateLastVisited', () => {
    ...
    it('queries last visited dates when set', () => {
      ...
      db.query
        .withArgs('client-contacts/contacts_by_last_visited')
        .resolves({
          rows: [
      ...
      db.query
        .withArgs('client-contacts/visits_by_date')
        .resolves({
          rows: [
      ...
      return service
        ...
        .then(result => {
          ...
          expect(db.query.args[1]).to.deep.equal([
            'client-contacts/contacts_by_last_visited',
      ...
      return service
        ...
        .then(result => {
          ...
          expect(db.query.args[1])
            .to.deep.equal([ 'client-contacts/contacts_by_last_visited', { reduce: true, group: true }]);
  ...
  describe('provided docIds', () => {
    ...
    it('queries for last visited date with the full list of ids', () => {
      ...
      db.query.withArgs('client-contacts/visits_by_date').resolves({ rows: []});
      db.query
        .withArgs('client-contacts/contacts_by_last_visited')
        .resolves({
          rows: [
