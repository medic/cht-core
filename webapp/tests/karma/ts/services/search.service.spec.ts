...
describe('Search service', () => {
  ...
  describe('dateLastVisited', () => {
    ...
    it('queries last visited dates when set', () => {
      ...
      db.query
        .withArgs(VIEWS.CONTACTS_BY_LAST_VISITED)
        .resolves({
          rows: [
      ...
      return service
        ...
        .then(result => {
          ...
          expect(db.query.args[1])
            .to.deep.equal([ VIEWS.CONTACTS_BY_LAST_VISITED, { reduce: true, group: true }]);
  ...
  describe('provided docIds', () => {
    ...
    it('queries for last visited date with the full list of ids', () => {
      ...
      db.query.withArgs(VIEWS.VISITS_BY_DATE).resolves({ rows: []});
      db.query
        .withArgs(VIEWS.CONTACTS_BY_LAST_VISITED)
        .resolves({
          rows: [
