...
describe('Reports Reducer', () => {
  ...
  describe('markReportRead', () => {
    it('should work on empty list', () => {
      const newState = reportsReducer(undefined, Actions.markReportRead('id'));
      expect(newState).to.deep.equal(state);
    });

    it('should work on existent list with invalid id', () => {
      state = {
        reports: [
          { _id: 'report1', reported_date: 1000 },
          { _id: 'report2', reported_date: 500 },
        ],
        reportsById: new Map([
          ['report1', { _id: 'report1', reported_date: 1000 }],
          ['report2', { _id: 'report2', reported_date: 500 }],
        ]),
      };
      const newState = reportsReducer(state, Actions.markReportRead('id'));
      expect(newState).to.deep.equal({
        reports: [
          { _id: 'report1', reported_date: 1000 },
          { _id: 'report2', reported_date: 500 },
    ...
    it('should work on existent list with valid id', () => {
      state = {
        reports: [
          { _id: 'report1', reported_date: 1000 },
          { _id: 'report2', reported_date: 500 },
      ...
      const newState = reportsReducer(state, Actions.markReportRead('report1'));
      expect(newState).to.deep.equal({
        reports: [
          { _id: 'report1', reported_date: 1000, read: true },
          { _id: 'report2', reported_date: 500 },
        ],
        reportsById: new Map([
          ['report1', { _id: 'report1', reported_date: 1000, read: true }],
          ['report2', { _id: 'report2', reported_date: 500 }],
        ]),
      });
    });
