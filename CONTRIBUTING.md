...
* Or [share a new idea](https://communityhealthtoolkit.org/forum) or [question](https://communityhealthtoolkit.org/forum) with us!
...
3. Provide detail about the issue you are solving in the pull request description. Note: If your pull request addresses a specific issue, use `address #[issue number]` or `closes #[issue number]` syntax in the pull request description as well.
